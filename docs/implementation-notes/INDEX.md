...
| [IMP-20260716-004](IMP-20260716-004-q-db-002-a-결정과-db-001-설계-명세.md) | 2026-07-16 | DB-001-DESIGN | decision | Q-DB-002=A 결정, ADR-0011, private schema·atomic approval·retention 설계 명세 | docs 2.3.11→2.3.12; product/API/DB/data/test 유지 | Decision-only Done — written spec review pending |
