...
| [IMP-20260716-006](IMP-20260716-006-db-001-layered-enforcement.md) | 2026-07-16 | DB-001 | implementation | exact CLI·PostgreSQL-only runtime·private schema와 table/lineage 불변조건 구현 | 목표 repo 1.5.0, DB 0.3.0-local, tests 0.5.0, docs 2.4.0 | In Progress — Task 4/10 complete |
