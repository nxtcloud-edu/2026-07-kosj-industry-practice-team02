...
| [IMP-20260716-006](IMP-20260716-006-db-001-layered-enforcement.md) | 2026-07-16 | DB-001 | implementation | 승인된 DB-001 실행 시작, 격리 worktree와 24/24 baseline | 목표 repo 1.5.0, DB 0.3.0-local, tests 0.5.0, docs 2.4.0 | In Progress |
