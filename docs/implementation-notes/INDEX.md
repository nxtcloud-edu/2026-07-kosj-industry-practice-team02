...
| [IMP-20260716-006](IMP-20260716-006-db-001-layered-enforcement.md) | 2026-07-16 | DB-001 | implementation | exact CLI와 PostgreSQL-only config, atomic local credential·SQL·rollback/replay gate 준비; schema 구현 진행 | 목표 repo 1.5.0, DB 0.3.0-local, tests 0.5.0, docs 2.4.0 | In Progress — Task 2/10 complete |
