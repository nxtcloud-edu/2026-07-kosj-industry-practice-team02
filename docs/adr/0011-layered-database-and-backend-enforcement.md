...
- Status: Accepted design; implementation candidate blocked by A-023/Q-SEC-005 before `0.3.0-local`
- Date: 2026-07-16
- Deciders: 사용자, Codex
...
`0.2.0-draft`를 유지한다. Q-SEC-004=A/D-029의 `default-local-port-binding`도 actual
`127.0.0.1`+`::`를 남겼다. Q-SEC-005/A-023 해결, exact single `127.0.0.1:54322`, full
