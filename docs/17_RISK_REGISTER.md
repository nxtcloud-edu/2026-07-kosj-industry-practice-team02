...
| R-018 | Codex Cloud에 비밀을 넣거나 Cloud 검증을 Docker/DeepSeek actual로 오인 | 중간 | 매우 높음 | Cloud secret 등록·local-only PASS 주장 | Cloud secret 0·agent internet off 기본·Draft PR-only·local-verification-required | Cloud 경계 변경 시 필요 |
