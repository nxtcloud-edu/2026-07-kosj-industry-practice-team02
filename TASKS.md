...
| DB-001 | P0 | Backend·Data·Security | [Supabase SQL v1 migration·보상 rollback·권한](docs/discovery/DB_001_DISCOVERY_REPORT.md) | Blocked — Q-SEC-005/A-023 IPv6 local port boundary | DEV-001 Done, approved [spec](docs/superpowers/specs/2026-07-16-db-001-layered-enforcement-design.md)·[plan](docs/superpowers/plans/2026-07-16-db-001-layered-enforcement.md), D-026~D-029, ADR-0012, [candidate report](docs/test-reports/DB-001-LOCAL-BASELINE.md), [handoff](docs/handoffs/HANDOFF-20260717-DB-001-LOCAL-BASELINE.md); Q-SEC-004=A의 `default-local-port-binding`은 actual `127.0.0.1`+`::`를 만들어 불충분했고 explicit loopback probe만 단일 binding; 두 probe 제거·container 0·DB mutation 0; manifest 미승격; A-021/Q-SEC-003 separately blocks public release | Q-SEC-005 인간 결정 → safe runtime exact single `127.0.0.1:54322` → full six-stage DB/root/static gate → independent review가 모두 통과할 때만 `0.3.0-local`/Done; 공식 seed 0·`/ready=503`; public/remote 금지 |
...
| DEPLOY-001 | P1 | Platform·Security·PM | 조건부 Vercel/Render/Supabase 공개 demo | Blocked | DEV-002, A-021/Q-SEC-003 해결, A-023/Q-SEC-005 해결, 별도 공개 배포 승인 | privileged function/public port hardening 뒤 계정·리전·CORS·비밀·로그·비용·admin gate 승인 시에만 URL/health/rollback |
