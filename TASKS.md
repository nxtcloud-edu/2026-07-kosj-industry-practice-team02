...
| COLLAB-001 | P0 | Platform·Security·Docs·Frontend | [private GitHub·Codex Cloud 협업 전환](docs/superpowers/specs/2026-07-20-github-codex-cloud-collaboration-design.md) | In Progress — Tasks 1~4 complete; Task 5 partial; Tasks 6~7 pending | D-047~D-055/ADR-0019, approved [execution plan](docs/superpowers/plans/2026-07-20-github-codex-cloud-collaboration-transition.md) | private `tskwak111/Sejong_AI` has matching local/remote `main` SHA `5e09deccc7205503df07d938b6d4a88f4d5a327e`; hosted policy `29776352710` and Frontend CI `29776352718` passed. `koregy` accepted write access, repository variable and direct-push warning are verified; teammate MFA/recovery and the first Task 7 PR-only/no-direct-main-push rehearsal remain human-only. Codex App restriction and Cloud/teammate rehearsals remain pending. public deployment/remote DB stay blocked |
