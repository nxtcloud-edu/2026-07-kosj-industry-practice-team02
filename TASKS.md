...
| DB-001 | P0 | Backend·Data·Security | [Supabase SQL v1 migration·보상 rollback·권한](docs/discovery/DB_001_DISCOVERY_REPORT.md) | In Progress — patched CLI [spec](docs/superpowers/specs/2026-07-17-q-sec-006-patched-supabase-cli-design.md)·[execution plan](docs/superpowers/plans/2026-07-17-q-sec-006-patched-supabase-cli.md) approved; Task 1 starting | DEV-001 Done, approved [DB spec](docs/superpowers/specs/2026-07-16-db-001-layered-enforcement-design.md)·[parent plan](docs/superpowers/plans/2026-07-16-db-001-layered-enforcement.md), D-026~D-031, ADR-0012/0013, [candidate report](docs/test-reports/DB-001-LOCAL-BASELINE.md), [handoff](docs/handoffs/HANDOFF-20260717-DB-001-LOCAL-BASELINE.md); Q-SEC-004/005 보정은 actual `127.0.0.1`+`::`로 불충분, explicit control만 단일 binding; container 0·DB mutation 0; manifest 미승격; A-021/Q-SEC-003 separately blocks public release | 5개 TDD review unit → source/toolchain/patch/binary hash → safe runtime exact single `127.0.0.1:54322` → full six-stage DB/root/static gate → independent review가 모두 통과할 때만 `0.3.0-local`/Done; 공식 seed 0·`/ready=503`; public/remote 금지 |
