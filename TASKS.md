...
| AI-001A | P0 | Backend·Security | [순수 fail-closed PII 마스킹 코어](docs/superpowers/specs/2026-07-20-ai-001-pii-masking-design.md)와 frozen v1 합성 평가셋 | Review | D-041/D-042, approved written spec, A-032/Q-PII-003, [execution plan](docs/superpowers/plans/2026-07-20-ai-001a-pii-masking-core.md) approval pending | 13범주·5 unresolved reason, v1 74 exact-output+10 bypass+Q-PII-003 policy+direct tests, miss/raw/log/I/O/dependency 0, API/DB/data/provider/route 불변; 전체 AI activation과 별도 |
