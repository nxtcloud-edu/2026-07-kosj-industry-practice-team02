...
| COLLAB-001 | P0 | Platform·Security·Docs·Frontend | [private GitHub·Codex Cloud 협업 전환](docs/superpowers/specs/2026-07-20-github-codex-cloud-collaboration-design.md) | In Progress — local Tasks 1~3 complete; external Tasks 4~7 pending human account actions | D-047~D-054/ADR-0019, approved [execution plan](docs/superpowers/plans/2026-07-20-github-codex-cloud-collaboration-transition.md), exact GitHub owner/repo/collaborator login 확인 | Q-GIT-004=A로 history·SHA 보존; local history/current-tree secret, scope/append, docs, workflow/template gates와 review Critical/Important 0 완료. 현재 remote 0·push 0·hosted Actions 0·Cloud task/PR 0이며 private `origin/main`, collaborator 수락, repository-limited Codex app, 인간 Frontend self-merge와 Cloud Draft-PR-only rehearsal 뒤에만 Done. public deployment/remote DB는 계속 blocked |
