...
| DB-001 | P0 | Backend·Data·Security | [Supabase SQL v1 migration·보상 rollback·권한](docs/discovery/DB_001_DISCOVERY_REPORT.md) | Blocked | DEV-001, [DB-001 서면 설계 명세](docs/superpowers/specs/2026-07-16-db-001-layered-enforcement-design.md) 사용자 검토 | empty DB reset/replay·보상 rollback/replay, 원자적 승인·retention·ACTIVE 공식 읽기·권한 테스트 통과 |
