...
| DB-001 | P0 | Backend·Data·Security | [Supabase SQL v1 migration·보상 rollback·권한](docs/discovery/DB_001_DISCOVERY_REPORT.md) | In Progress | DEV-001 Done, [서면 명세](docs/superpowers/specs/2026-07-16-db-001-layered-enforcement-design.md) Approved, [DB-001 실행계획](docs/superpowers/plans/2026-07-16-db-001-layered-enforcement.md) Approved, D-026/D-027, [Task 6 완료 노트](docs/implementation-notes/IMP-20260717-001-db-001-task-6-atomic-candidate-workflow.md); Task 6/10 complete, Task 7 ready | empty DB reset/replay·보상 rollback/replay, fail-closed role 검증, 별도 실패 사유 확인·후보 gate, 원자적 승인·review comment·retention·ACTIVE 공식 읽기·권한 테스트 통과 |
