...
| MVP-001 | P0 | 전체 | [7/25 local/private 핵심 개선 루프](docs/superpowers/specs/2026-07-22-four-day-local-private-core-loop-mvp-design.md) | In Progress | Q-MVP-001=A/D-058/ADR-0020, [audit](docs/discovery/MVP_001_FOUR_DAY_LOCAL_PRIVATE_AUDIT.md), [approved plan](docs/superpowers/plans/2026-07-22-four-day-local-private-core-loop-mvp.md) | 19 ACTIVE seed→chat `/api/v1/chat`+`/chat`→failure/candidate/different approval→20 ACTIVE→same-query success, 최소 `/admin`, 표본 20·회귀 1·security/demo. DeepSeek tuning·100명·자동 backup·public deploy는 7/25 뒤 |
...
| DATA-SEED-002 | P0 | Backend·Data·Security | [immutable `.2` successor와 actual DB 재검증](docs/superpowers/specs/2026-07-20-data-seed-002-successor-release-correction-design.md) | In Progress | D-044/D-058/ADR-0017/0020, approved DATA-001 19/3/10, [approved execution plan](docs/superpowers/plans/2026-07-20-data-seed-002-successor-release-correction.md) | `.1`/v1 byte 불변, migration three-`EXISTS` 의미로 one pgTAP predicate 정렬, `.2` effective-option union seed/compensation, independent technical review, atomic dispatcher, full actual cycle. 모든 PASS 뒤에만 `official_data=.2`; `/ready=503` 유지 |
...
| PII-CONSUMER-001 | P0 | Backend·Frontend 팀원·Security·Contract | `PRIVACY_UNRESOLVED` HTTP 200 consumer 계약 | Ready / MVP plan approved | D-045/D-058/ADR-0004/0020, approved MVP-001 spec/plan | no source/context/office/provider/text/failed row/candidate. 7/25 local milestone은 DB event 0으로 닫고 public enum/JSON Schema/Pydantic/TS를 동시 변경; persistent metadata migration은 reserved `00700` 뒤 별도 |
