...
| DATA-SEED-001 | P0 | Backend·Data·Security | 승인 record의 immutable official release·버전 seed·lineage | **Blocked** | DATA-001 approved manifest, D-036/D-038/D-039, approved [design](docs/superpowers/specs/2026-07-19-data-seed-immutable-release-design.md)/[plan](docs/superpowers/plans/2026-07-19-data-seed-immutable-release-and-local-verification.md), A-030/Q-SEED-002 인간 결정 | `.1` filesystem 19/3/10 release·byte-identical dispatcher·Task 7A offline gate는 PASS; `[db.seed].enabled=false`. Actual DB는 seed write 전 effective-option union 대 immutable single-row guard 충돌로 Blocked, ACTIVE/READY/official-data 승격 없음. [lineage](docs/data-lineage/DATA-SEED-001-0.1.0-initial.1.md), [actual report](docs/test-reports/DATA-SEED-001-LOCAL-VERIFICATION.md), [IMP-20260719-008](docs/implementation-notes/IMP-20260719-008-data-seed-001-불변-공식-release와-local-seed-검증.md) |
...
| AI-001A | P0 | Backend·Security | [순수 fail-closed PII 마스킹 코어](docs/superpowers/specs/2026-07-20-ai-001-pii-masking-design.md)와 frozen v1 합성 평가셋 | Ready | D-041/D-042/D-043, approved written spec, A-032 Resolved, [approved execution plan](docs/superpowers/plans/2026-07-20-ai-001a-pii-masking-core.md) | 13범주·5 unresolved reason, v1 74 exact-output+10 bypass+Q-PII-003 policy+direct tests, miss/raw/log/I/O/dependency 0, API/DB/data/provider/route 불변; 전체 AI activation과 별도 |
| AI-001 | P0 | AI/Data·Backend·Security | 보수적 PII 마스킹과 분류·검색·근거 gate·template 응답 | Blocked | DATA-SEED-001, AI-001A, A-031/Q-PII-002 before consumer activation | core 뒤 provider payload/DB writer spy 원문 0, ACTIVE 전용 검색, 시민-visible privacy fallback 계약, PII 100%·성공률 동시 측정 |
