...
| DB-001 | P0 | Backend·Data·Security | [Supabase SQL v1 migration·보상 rollback·권한](docs/discovery/DB_001_DISCOVERY_REPORT.md) | In Progress — Task 9 complete / Task 10 ready | DEV-001 Done, approved [spec](docs/superpowers/specs/2026-07-16-db-001-layered-enforcement-design.md)·[plan](docs/superpowers/plans/2026-07-16-db-001-layered-enforcement.md), D-026/D-027/D-028, ADR-0012, [Task 9A plan](docs/superpowers/plans/2026-07-17-db-001-deferred-trigger-security-fix.md), commits `5266abc`/`04a944f`/`228d8cb`; Tasks 0~9 complete, full pgTAP 282, integration 8/8, exact six-stage replay PASS; Task 10/version/handoff pending; A-021 public-release blocker | empty DB reset/replay·6단계 보상 rollback/replay, fail-closed role, 사유 확인·후보 gate, 원자 승인·retention·ACTIVE 공식 읽기·lazy typed API, tooling/root/secret/package/zero-row와 독립 review 통과; Task 10이 authority/version/handoff를 마감 |
