...
| ID | 우선순위 | 담당 영역 | 작업 | 상태 | 의존성 | 완료 기준 |
|---|---|---|---|---|---|---|
| DATA-001 | P0 | AI/Data·Backend 작성, PM 승인 | 공식 KB 20건·기관 3건·지역×민원 매핑 12건 staging 작성·전수 검수 | In Progress — approved spec/plan, AI DRAFT+validator execution; PM review KEEP | [DATA plan](docs/superpowers/plans/2026-07-18-data-001-staging-and-review-package.md), D-033/ADR-0015 | 2026-07-20까지 20/3/12 schema·source·PII 검증, hash-bound PENDING manifest; initial projection KB 19+WASTE-03 보류, mapping 10 approve/2 reject 권고, official release/seed 0 |
