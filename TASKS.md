...
| MVP-001 | P0 | 전체 | [7/25 local/private 핵심 개선 루프](docs/superpowers/specs/2026-07-22-four-day-local-private-core-loop-mvp-design.md) | Review — local/private AI scope complete; human review/manual gates pending | Q-MVP-001=A/D-058/ADR-0020, [approved plan](docs/superpowers/plans/2026-07-22-four-day-local-private-core-loop-mvp.md), [sample report](docs/test-reports/MVP-001-SAMPLE-20-RESULT.md) | final ACTIVE 20/requery/ready200, sample 20/20, API 1,640, Web 48/E2E15, contracts89, DB pgTAP9/356+integration8/8, root offline PASS. Draft PR review/merge와 manual demo/a11y는 인간 Pending. public/admin auth/remote/provider-ready 아님 |
