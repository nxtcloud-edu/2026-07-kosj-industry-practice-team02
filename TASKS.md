...
| DB-001 | P0 | Backend·Data·Security | [Supabase SQL v1 migration·보상 rollback·권한](docs/discovery/DB_001_DISCOVERY_REPORT.md) | Blocked — patched CLI Tasks 1/2/2A/2B implemented/reviewed; A-025/Q-TOOL-001 build workspace decision required before Task 3 | DEV-001 Done, approved [DB spec](docs/superpowers/specs/2026-07-16-db-001-layered-enforcement-design.md)·[parent plan](docs/superpowers/plans/2026-07-16-db-001-layered-enforcement.md), D-026~D-031, A-025/Q-TOOL-001, ADR-0012/0013, [patched plan](docs/superpowers/plans/2026-07-17-q-sec-006-patched-supabase-cli.md), [candidate report](docs/test-reports/DB-001-LOCAL-BASELINE.md), [handoff](docs/handoffs/HANDOFF-20260717-DB-001-LOCAL-BASELINE.md); exact diagnostic build PASS but PS5.1 long-path cleanup partial failure; container 0·DB mutation 0; runtime/manifest 미생성; A-021/Q-SEC-003 separately blocks public release | Q-TOOL-001 결정 → revised TDD/review → source/toolchain/patch/binary hash → safe runtime exact single `127.0.0.1:54322` → full six-stage DB/root/static gate → independent review가 모두 통과할 때만 `0.3.0-local`/Done; 공식 seed 0·`/ready=503`; public/remote 금지 |
