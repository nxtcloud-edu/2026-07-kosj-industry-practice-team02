...
| DB-001 | P0 | Backend·Data·Security | [Supabase SQL v1 migration·보상 rollback·권한](docs/discovery/DB_001_DISCOVERY_REPORT.md) | In Progress — Task 9A remediation | DEV-001 Done, [서면 명세](docs/superpowers/specs/2026-07-16-db-001-layered-enforcement-design.md) Approved, [DB-001 실행계획](docs/superpowers/plans/2026-07-16-db-001-layered-enforcement.md) Approved, D-026/D-027/D-028, ADR-0012, [Task 9A 계획](docs/superpowers/plans/2026-07-17-db-001-deferred-trigger-security-fix.md), [Task 8 완료 노트](docs/implementation-notes/IMP-20260717-003-db-001-task-8-lazy-typed-database-boundary.md), [Task 9 역사 노트](docs/implementation-notes/IMP-20260717-004-db-001-task-9-deferred-trigger-permission-blocker.md); Tasks 0~8 complete, Task 9 partial 6/8, Q-DB-003 resolved, remediation pending | empty DB reset/replay·6단계 보상 rollback/replay, fail-closed role 검증, 별도 실패 사유 확인·후보 gate, 원자적 승인·review comment·retention·ACTIVE 공식 읽기·lazy typed API 경계·권한 테스트 통과 |
