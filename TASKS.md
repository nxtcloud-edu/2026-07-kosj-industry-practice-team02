...
| COLLAB-001 | P0 | Platform·Security·Docs·Frontend | [private GitHub·Codex Cloud 협업 전환](docs/superpowers/specs/2026-07-20-github-codex-cloud-collaboration-design.md) | In Progress — Tasks 1~4 complete; Task 5 partial; Task 6 partial (manual merge complete); Task 7 pending | D-047~D-057/ADR-0019, approved [execution plan](docs/superpowers/plans/2026-07-20-github-codex-cloud-collaboration-transition.md), [owner checklist](docs/handoffs/HANDOFF-20260721-OWNER-GITHUB-CLOUD-CHECKLIST.md) | PR #1~#3가 merge됐고 remote `main`은 PR #3 merge commit `d54fd6f`이다. corrected Cloud rehearsal은 정확히 두 문서만 변경했고 PR 및 post-merge hosted policy/Frontend CI가 PASS했다. Cloud 내부와 GitHub 게시 식별자도 정정됐다. Cloud exact runtime version evidence, `koregy` MFA/recovery·첫 Task 7 PR-only와 teammate onboarding rehearsals은 Pending이며 public deployment/remote DB는 계속 차단한다 |
