...
| DB-001 | P0 | Backend·Data·Security | [Supabase SQL v1 migration·보상 rollback·권한](docs/discovery/DB_001_DISCOVERY_REPORT.md) | In Progress | DEV-001 Done, [서면 명세](docs/superpowers/specs/2026-07-16-db-001-layered-enforcement-design.md) Approved, [DB-001 실행계획](docs/superpowers/plans/2026-07-16-db-001-layered-enforcement.md) Approved, [IMP-20260716-006](docs/implementation-notes/IMP-20260716-006-db-001-layered-enforcement.md) | empty DB reset/replay·보상 rollback/replay, 원자적 승인·retention·ACTIVE 공식 읽기·권한 테스트 통과 |
