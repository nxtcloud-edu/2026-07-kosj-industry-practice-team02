...
| COLLAB-001 | P0 | Platform·Security·Docs·Frontend | [private GitHub·Codex Cloud 협업 전환](docs/superpowers/specs/2026-07-20-github-codex-cloud-collaboration-design.md) | In Progress — Tasks 1~4 complete; Task 5 partial; Task 6 complete; Task 7 HOLD | D-047~D-057/ADR-0019, approved [execution plan](docs/superpowers/plans/2026-07-20-github-codex-cloud-collaboration-transition.md), [owner checklist](docs/handoffs/HANDOFF-20260721-OWNER-GITHUB-CLOUD-CHECKLIST.md) | PR #1~#3/post-merge checks와 Cloud exact Node/Python/pnpm/uv·clean tree·zero-use evidence PASS. `koregy` PR #4는 open/non-draft이나 teammate note `IMP-20260721-012`가 owner local note `012`와 충돌하므로 HOLD다. owner 012/013/015 통합 뒤 teammate note `014` rename·PR/CI/self-merge가 필요하다. MFA/recovery yes/no도 Pending이며 public deployment/remote DB는 계속 차단한다 |
